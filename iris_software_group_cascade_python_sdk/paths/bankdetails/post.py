...
from iris_software_group_cascade_python_sdk.model.create_bank_details_command import CreateBankDetailsCommand as CreateBankDetailsCommandSchema

from iris_software_group_cascade_python_sdk.type.create_bank_details_command import CreateBankDetailsCommand
from iris_software_group_cascade_python_sdk.type.bank_address import BankAddress

from ...api_client import Dictionary
from iris_software_group_cascade_python_sdk.pydantic.create_bank_details_command import CreateBankDetailsCommand as CreateBankDetailsCommandPydantic
from iris_software_group_cascade_python_sdk.pydantic.bank_address import BankAddress as BankAddressPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJsonodataMetadataminimalodataStreamingtrueVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadataminimalodataStreamingfalseVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadataminimalVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullodataStreamingtrueVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullodataStreamingfalseVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneodataStreamingtrueVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneodataStreamingfalseVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataStreamingtrueVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonodataStreamingfalseVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationXmlVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationPrsOdatatestxxOdataVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyTextJsonVersion1 = CreateBankDetailsCommandSchema
SchemaForRequestBodyApplicationJsonVersion1 = CreateBankDetailsCommandSchema


request_body_create_bank_details_command = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_bank_detail_mapped_args(
        self,
    ...
    async def _acreate_bank_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/bankdetails',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_create_bank_details_command.serialize(body, content_type)
...
class CreateBankDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_bank_detail(
        self,
        employee_id: typing.Optional[typing.Optional[str]] = None,
        bank_name: typing.Optional[typing.Optional[str]] = None,
        bank_address: typing.Optional[BankAddress] = None,
        ...
        **kwargs,
        ...
        args = self._create_bank_detail_mapped_args(
        ...
        return await self._acreate_bank_detail_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_bank_detail(
        ...
        return self._create_bank_detail_oapg(
            body=args.body,
        )

class CreateBankDetail(BaseApi):
    ...
    async def acreate_bank_detail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_bank_detail(
            employee_id=employee_id,
            bank_name=bank_name,
            bank_address=bank_address,
            account_name=account_name,
    ...
    def create_bank_detail(
        ...
        raw_response = self.raw.create_bank_detail(
            employee_id=employee_id,
            bank_name=bank_name,
            bank_address=bank_address,
            account_name=account_name,
