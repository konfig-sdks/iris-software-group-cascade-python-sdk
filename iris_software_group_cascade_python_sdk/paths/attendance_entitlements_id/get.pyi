...
from iris_software_group_cascade_python_sdk.model.entitlement_model import EntitlementModel as EntitlementModelSchema

from iris_software_group_cascade_python_sdk.type.entitlement_model import EntitlementModel

from ...api_client import Dictionary
from iris_software_group_cascade_python_sdk.pydantic.entitlement_model import EntitlementModel as EntitlementModelPydantic
...
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalodataStreamingtrueVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalodataStreamingfalseVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullodataStreamingtrueVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullodataStreamingfalseVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneodataStreamingtrueVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneodataStreamingfalseVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataStreamingtrueVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonodataStreamingfalseVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationJsonVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationXmlVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyApplicationPrsOdatatestxxOdataVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyTextPlainVersion1 = EntitlementModelSchema
SchemaFor200ResponseBodyTextJsonVersion1 = EntitlementModelSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EntitlementModel
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/attendance/entitlements/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EntitlementModelPydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return EntitlementModelPydantic(**raw_response.body)
        return api_client.construct_model_instance(EntitlementModelPydantic, raw_response.body)
