...
from iris_software_group_cascade_python_sdk.model.create_absence_command import CreateAbsenceCommand as CreateAbsenceCommandSchema

from iris_software_group_cascade_python_sdk.type.create_absence_command import CreateAbsenceCommand

from ...api_client import Dictionary
from iris_software_group_cascade_python_sdk.pydantic.create_absence_command import CreateAbsenceCommand as CreateAbsenceCommandPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJsonodataMetadataminimalodataStreamingtrueVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadataminimalodataStreamingfalseVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadataminimalVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullodataStreamingtrueVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullodataStreamingfalseVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneodataStreamingtrueVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneodataStreamingfalseVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataStreamingtrueVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonodataStreamingfalseVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationXmlVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationPrsOdatatestxxOdataVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyTextJsonVersion1 = CreateAbsenceCommandSchema
SchemaForRequestBodyApplicationJsonVersion1 = CreateAbsenceCommandSchema


request_body_create_absence_command = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_absence_mapped_args(
        ...
        absence_reason_id: typing.Optional[typing.Optional[str]] = None,
        ...
        if absence_reason_id is not None:
            _body["AbsenceReasonId"] = absence_reason_id
    ...
    async def _acreate_new_absence_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/attendance/absences',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_create_absence_command.serialize(body, content_type)
