...
from iris_software_group_cascade_python_sdk.model.update_absence_day_command import UpdateAbsenceDayCommand as UpdateAbsenceDayCommandSchema
...
from iris_software_group_cascade_python_sdk.type.update_absence_day_command import UpdateAbsenceDayCommand
...
from iris_software_group_cascade_python_sdk.pydantic.update_absence_day_command import UpdateAbsenceDayCommand as UpdateAbsenceDayCommandPydantic
...
# body param
SchemaForRequestBodyApplicationJsonodataMetadataminimalodataStreamingtrueVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadataminimalodataStreamingfalseVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadataminimalVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullodataStreamingtrueVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullodataStreamingfalseVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatafullVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneodataStreamingtrueVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneodataStreamingfalseVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataMetadatanoneVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataStreamingtrueVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonodataStreamingfalseVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationXmlVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationPrsOdatatestxxOdataVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyTextJsonVersion1 = UpdateAbsenceDayCommandSchema
SchemaForRequestBodyApplicationJsonVersion1 = UpdateAbsenceDayCommandSchema


request_body_update_absence_day_command = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_absence_day_mapped_args(
        self,
        id: str,
    ...
    async def _aupdate_absence_day_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/attendance/absencedays/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_update_absence_day_command.serialize(body, content_type)
...
class UpdateAbsenceDayRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_absence_day(
        self,
        id: str,
        date: typing.Optional[datetime] = None,
        duration_days: typing.Optional[typing.Union[int, float]] = None,
        ...
        **kwargs,
        ...
        args = self._update_absence_day_mapped_args(
            id=id,
            date=date,
        ...
        return await self._aupdate_absence_day_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_absence_day(
        self,
        id: str,
        date: typing.Optional[datetime] = None,
        duration_days: typing.Optional[typing.Union[int, float]] = None,
        ...
        return self._update_absence_day_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateAbsenceDay(BaseApi):
    ...
    async def aupdate_absence_day(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_absence_day(
            id=id,
            date=date,
            duration_days=duration_days,
            duration_minutes=duration_minutes,
    ...
    def update_absence_day(
        ...
        raw_response = self.raw.update_absence_day(
            id=id,
            date=date,
            duration_days=duration_days,
            duration_minutes=duration_minutes,
