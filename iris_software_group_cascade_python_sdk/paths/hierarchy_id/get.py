...
class BaseApi(api_client.Api):
    ...
    def _get_node_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_node_by_id_oapg(
        self,
...
class GetNodeByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_node_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_node_by_id_mapped_args(
            id=id,
        )
        return await self._aget_node_by_id_oapg(
    ...
    def get_node_by_id(
        ...
        return self._get_node_by_id_oapg(
            path_params=args.path,
        )

class GetNodeById(BaseApi):
    ...
    async def aget_node_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_node_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_node_by_id(
        ...
        raw_response = self.raw.get_node_by_id(
            id=id,
        )
        if validate:
            return HierarchyNodeModelPydantic(**raw_response.body)
