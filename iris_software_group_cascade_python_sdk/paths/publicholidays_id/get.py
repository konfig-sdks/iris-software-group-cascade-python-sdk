...
from iris_software_group_cascade_python_sdk.model.public_holiday_model import PublicHolidayModel as PublicHolidayModelSchema

from iris_software_group_cascade_python_sdk.type.public_holiday_model import PublicHolidayModel

from ...api_client import Dictionary
from iris_software_group_cascade_python_sdk.pydantic.public_holiday_model import PublicHolidayModel as PublicHolidayModelPydantic
...
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalodataStreamingtrueVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalodataStreamingfalseVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullodataStreamingtrueVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullodataStreamingfalseVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneodataStreamingtrueVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneodataStreamingfalseVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataStreamingtrueVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonodataStreamingfalseVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationJsonVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationXmlVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyApplicationPrsOdatatestxxOdataVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyTextPlainVersion1 = PublicHolidayModelSchema
SchemaFor200ResponseBodyTextJsonVersion1 = PublicHolidayModelSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_location_list_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_location_list_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/publicholidays/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_location_list_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetLocationListByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_location_list_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_location_list_by_id_mapped_args(
            id=id,
        )
        return await self._aget_location_list_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_location_list_by_id(
        self,
        id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_location_list_by_id_oapg(
            path_params=args.path,
        )

class GetLocationListById(BaseApi):
    ...
    async def aget_location_list_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PublicHolidayModelPydantic:
        raw_response = await self.raw.aget_location_list_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return PublicHolidayModelPydantic(**raw_response.body)
        return api_client.construct_model_instance(PublicHolidayModelPydantic, raw_response.body)
    ...
    def get_location_list_by_id(
        ...
        raw_response = self.raw.get_location_list_by_id(
            id=id,
        )
        if validate:
            return PublicHolidayModelPydantic(**raw_response.body)
