...
from iris_software_group_cascade_python_sdk.model.absence_reason_model import AbsenceReasonModel as AbsenceReasonModelSchema

from iris_software_group_cascade_python_sdk.type.absence_reason_model import AbsenceReasonModel

from ...api_client import Dictionary
from iris_software_group_cascade_python_sdk.pydantic.absence_reason_model import AbsenceReasonModel as AbsenceReasonModelPydantic
...
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalodataStreamingtrueVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalodataStreamingfalseVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadataminimalVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullodataStreamingtrueVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullodataStreamingfalseVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatafullVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneodataStreamingtrueVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneodataStreamingfalseVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataMetadatanoneVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataStreamingtrueVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonodataStreamingfalseVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationJsonVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationXmlVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyApplicationPrsOdatatestxxOdataVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyTextPlainVersion1 = AbsenceReasonModelSchema
SchemaFor200ResponseBodyTextJsonVersion1 = AbsenceReasonModelSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AbsenceReasonModel
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/attendance/absencereasons/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AbsenceReasonModelPydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return AbsenceReasonModelPydantic(**raw_response.body)
        return api_client.construct_model_instance(AbsenceReasonModelPydantic, raw_response.body)
