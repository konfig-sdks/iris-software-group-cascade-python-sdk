...
class RequiredJobModel(TypedDict):
    pass

class OptionalJobModel(TypedDict, total=False):
    ...
    PublicHoliday: typing.Optional[str]
    ...
    SpinalPoint: typing.Optional[int]
    ...
    TimesheetRuleSet: typing.Optional[str]
    ...
    AutoEnrolmentProfile: typing.Optional[str]
    ...
    ReportsToPost: typing.Optional[str]
...
class JobModel(RequiredJobModel, OptionalJobModel):
    pass
