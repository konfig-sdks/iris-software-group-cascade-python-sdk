...
class RequiredUpdateJobCommand(TypedDict):
    pass

class OptionalUpdateJobCommand(TypedDict, total=False):
...
class UpdateJobCommand(RequiredUpdateJobCommand, OptionalUpdateJobCommand):
    pass
