...
class RequiredCreateEmployeeCommand(TypedDict):
    pass

class OptionalCreateEmployeeCommand(TypedDict, total=False):
...
class CreateEmployeeCommand(RequiredCreateEmployeeCommand, OptionalCreateEmployeeCommand):
    pass
