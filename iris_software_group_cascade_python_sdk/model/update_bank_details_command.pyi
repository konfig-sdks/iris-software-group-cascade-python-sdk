...
class UpdateBankDetailsCommand(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["BankName", "BankAddress", "AccountName", "AccountNumber", "SortCode", "RollNumber", "Id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["BankName", "BankAddress", "AccountName", "AccountNumber", "SortCode", "RollNumber", "Id", ], str]):
