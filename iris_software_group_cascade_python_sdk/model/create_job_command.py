...
class CreateJobCommand(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["JobTitle", "Classification", "StartDate", "EndDate", "WorkingCalendar", "LineManagerId", "HierarchyNodeId", "Active", "Salary", "EmployeeId", "Contract", "PayFrequency", "PayBasis", "FullTimeEquivalent", "ChangeReason", "NextIncrementDate", "TimesheetLocation", "TimesheetLunchDuration", "ExpenseSubmissionFrequency", "CostCentre", "JobFamily", "ApprenticeUnder25", "ApprenticeshipEndDate", "ContractEndDate", "NormalHours", "RealTimeInformationIrregularFrequency", "NoticePeriod", ], str]):
