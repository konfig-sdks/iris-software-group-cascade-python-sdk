...
class UpdateAbsenceDayCommand(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Date", "DurationDays", "DurationMinutes", "DayPart", "Id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Date", "DurationDays", "DurationMinutes", "DayPart", "Id", ], str]):
