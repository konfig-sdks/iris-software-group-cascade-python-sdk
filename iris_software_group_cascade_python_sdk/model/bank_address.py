...
class BankAddress(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Address1", "Address2", "Address3", "Address4", "PostCode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Address1", "Address2", "Address3", "Address4", "PostCode", ], str]):
