...
from iris_software_group_cascade_python_sdk.pydantic.employee_model import EmployeeModel
...
class EmployeeQueryModel(BaseModel):
    ...
    value: typing.Optional[typing.Optional[typing.List[EmployeeModel]]] = Field(None, alias='Value')
