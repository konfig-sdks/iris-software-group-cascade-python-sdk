...
from iris_software_group_cascade_python_sdk.pydantic.hierarchy_node_model import HierarchyNodeModel

class HierarchyNodeQueryModel(BaseModel):
    ...
    value: typing.Optional[typing.Optional[typing.List[HierarchyNodeModel]]] = Field(None, alias='Value')
