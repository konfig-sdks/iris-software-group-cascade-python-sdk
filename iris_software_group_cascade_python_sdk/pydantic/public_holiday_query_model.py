...
from iris_software_group_cascade_python_sdk.pydantic.public_holiday_model import PublicHolidayModel

class PublicHolidayQueryModel(BaseModel):
    ...
    value: typing.Optional[typing.Optional[typing.List[PublicHolidayModel]]] = Field(None, alias='Value')
