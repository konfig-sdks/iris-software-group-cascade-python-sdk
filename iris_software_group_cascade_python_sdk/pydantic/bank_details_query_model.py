...
from iris_software_group_cascade_python_sdk.pydantic.bank_details_model import BankDetailsModel

class BankDetailsQueryModel(BaseModel):
    ...
    value: typing.Optional[typing.Optional[typing.List[BankDetailsModel]]] = Field(None, alias='Value')
