...
from iris_software_group_cascade_python_sdk.pydantic.entitlement_model import EntitlementModel

class EntitlementQueryModel(BaseModel):
    ...
    value: typing.Optional[typing.Optional[typing.List[EntitlementModel]]] = Field(None, alias='Value')
