...
from iris_software_group_cascade_python_sdk.pydantic.absence_query_model_value import AbsenceQueryModelValue

class AbsenceQueryModel(BaseModel):
    ...
    value: typing.Optional[AbsenceQueryModelValue] = Field(None, alias='Value')
