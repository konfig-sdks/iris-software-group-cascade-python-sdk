...
from iris_software_group_cascade_python_sdk.pydantic.job_model import JobModel
...
class JobQueryModel(BaseModel):
    ...
    value: typing.Optional[typing.Optional[typing.List[JobModel]]] = Field(None, alias='Value')
