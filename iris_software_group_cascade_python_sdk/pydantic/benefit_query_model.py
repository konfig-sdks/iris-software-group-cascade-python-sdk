...
from iris_software_group_cascade_python_sdk.pydantic.benefit_model import BenefitModel

class BenefitQueryModel(BaseModel):
    ...
    value: typing.Optional[typing.Optional[typing.List[BenefitModel]]] = Field(None, alias='Value')
