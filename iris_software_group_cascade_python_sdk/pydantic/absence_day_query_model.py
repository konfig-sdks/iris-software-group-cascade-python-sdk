...
from iris_software_group_cascade_python_sdk.pydantic.absence_day_model import AbsenceDayModel

class AbsenceDayQueryModel(BaseModel):
    ...
    value: typing.Optional[typing.Optional[typing.List[AbsenceDayModel]]] = Field(None, alias='Value')
