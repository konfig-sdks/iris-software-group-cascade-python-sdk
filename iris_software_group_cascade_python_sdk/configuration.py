...
from iris_software_group_cascade_python_sdk.exceptions_base import ApiValueError
from iris_software_group_cascade_python_sdk.exceptions import ClientConfigurationError
...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.iris.co.uk/hr/v2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("iris_software_group_cascade_python_sdk")
...
class OAuth:
    def __init__(self, client_id: typing.AnyStr, client_secret: typing.AnyStr, token_url: str = "https://api.iris.co.uk/oauth2/v1/token") -> None:
