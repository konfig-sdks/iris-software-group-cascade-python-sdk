...
from iris_software_group_cascade_python_sdk.paths.publicholidays_id import get
from iris_software_group_cascade_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestPublicholidaysId(ApiTestMixin, unittest.TestCase):
    """
    PublicholidaysId unit test stubs
